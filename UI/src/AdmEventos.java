...
public class AdmEventos {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdmEventos window = new AdmEventos();
	...
	private void initialize() {
		...
		listaEventos.setModel(new AbstractListModel() {
			String[] values = new String[] {"1 - Evento teste - 20/05/2020", "2 - Evento teste - 20/05/2020", "3 - Evento teste - 20/05/2020", "4 - Evento teste - 20/05/2020", "5 - Evento teste - 20/05/2020", "6 - Evento teste - 20/05/2020"};
			public int getSize() {
		...
		selectTipo.setModel(new DefaultComboBoxModel(new String[] {"Show", "Festival", "Teatro", "Cinema", "Palestra", "Workshop"}));
